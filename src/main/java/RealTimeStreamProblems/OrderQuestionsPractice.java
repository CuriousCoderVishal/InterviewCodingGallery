...
public class OrderQuestionsPractice {
...
*/
        ...
        List<Product> products = orders.stream()
                ...
                .filter(order -> order.getOrderDate().isAfter(LocalDate.of(2021, 02, 01)) && order.getOrderDate().isBefore(LocalDate.of(2021, 04, 01)))
...
*/
       ...
       List<Order> orders1 = orders.stream()
        ...
        orders.stream()
                .filter(order -> order.getOrderDate().equals(LocalDate.of(2021, 02, 15)))

...
public class OrderTest {
    ...
    public static void main(String[] args) {
        ...
        List<Order> orderWithCategoryBaby = orders.stream()
        ...
        products.stream()
                ...
                .map(product -> {
                    double newPrice = 0.9 * product.getPrice();
        ...
        //Ex 5.1 - Cheapest product in each category
        products.stream()
...
*/
        ...
        /* orders.stream()
                        .collect(Collectors.toMap(Order::getId,order -> order.getProducts().stream().collect(Collectors.counting())))
                                .forEach((aLong, aLong2) -> System.out.println(aLong+"--"+aLong2));*/
        System.out.println("\n\nExercise 11 — Obtain a data map with order id and order’s product count");
        orders.stream()
        ...
        orders.stream()
                ...
                .forEach((customer, orders1) -> System.out.println(customer + "---" + orders1));
        ...
        orders.stream()
                .collect(Collectors.toMap(Function.identity(), order -> order.getProducts().stream().
                        collect(Collectors.summingDouble(Product::getPrice))))
                .forEach((order, aDouble) -> System.out.println(order + "-----" + aDouble));
...
*/
        ...
        System.out.println("\n\nExercise 13.1 — Produce a data map with order record and product total sum");
        ...
        Map<String, List<String>> stringListMap = products.stream()
